    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">Siparişlerim & Sevkiyat Takibi</h1>
        ...
        <div className="flex items-center gap-2 flex-wrap self-start">
          <button
            onClick={loadOrders}
            className="p-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-xl transition"
            title="Yenile"
          >
          ...
          <div className="sm:col-span-2 flex items-center justify-end">
            {(searchNo || statusFilter !== 'all') && (
              <button
                ...
                className="w-full py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition"
              >
