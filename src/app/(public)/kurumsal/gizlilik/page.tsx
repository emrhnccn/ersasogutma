...
export default function PrivacyPolicyPage() {
  return (
    <div className="space-y-6 max-w-4xl mx-auto text-xs">
      <div>
        <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-bold uppercase tracking-wider mb-1">
          <Lock className="w-4 h-4" />
          <span>Veri Güvenliği & KVKK</span>
        </div>
        <h1 className="text-2xl font-black text-slate-900 dark:text-white">Güvenlik ve Gizlilik Politikası</h1>
      ...
      <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 shadow-xs rounded-2xl p-6 sm:p-8 shadow-xl space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <div className="p-4 bg-slate-50 dark:bg-[#0B1120] rounded-xl border border-slate-200 dark:border-slate-800 flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-slate-900 dark:text-white text-sm">256-Bit SSL Sertifikalı Güvenli Altyapı</div>
        ...
        <section className="space-y-2">
          ...
          <p>
            Ersa Soğutma B2B Sanal POS sisteminde kart bilgileriniz sunucularımızda kesinlikle <strong className="text-slate-900 dark:text-white">saklanmaz ve kaydedilmez</strong>. Ödeme anında girilen kart verileri doğrudan bankanın güvenli 3D Secure sistemine iletilir ve bankadan SMS onay kodu gelmeden tahsilat gerçekleştirilmez.
          </p>
        </section>
