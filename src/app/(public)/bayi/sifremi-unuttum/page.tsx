          ...
          {successInfo ? (
            <div className="space-y-6 text-center">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-white">Talep Alındı</h3>
              ...
              {successInfo.resetUrl && (
                <div className="p-4 bg-sky-950/40 border border-sky-800/40 rounded-2xl text-left space-y-2">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-xs font-bold text-sky-300 hover:text-sky-200 underline break-all"
                  >
              ...
              <div className="pt-2">
                <Link
                  href="/bayi/login"
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-sm font-semibold text-white transition"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-xl font-bold text-sm text-white bg-sky-600 hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition disabled:opacity-50"
              >
