    ...
    <div className="bg-white text-slate-600 text-xs border-b border-slate-200 py-1.5 px-4 sticky top-0 z-40 shadow-2xs">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex items-center gap-1.5 text-blue-600 font-semibold tracking-wider">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-emerald-600 hover:text-emerald-700 transition font-semibold"
          >
            <PhoneCall className="w-3.5 h-3.5" />
            <span className="hidden sm:inline">B2B WhatsApp: 0532 555 41 41</span>
          </a>
